 ...
 *
 */
RC2PY1Profile::RC2PY1Profile(TalonSRX & talon) : _talon(talon), _notifer(&RC2PY1Profile::PeriodicTask, this)
{
 ...
 *
 */
void RC2PY1Profile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RC2PY1Profile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RC2PY1Profile::startFilling()
{
	startFilling(kRC2PY1Profile, kRC2PY1ProfileSz);
}

/**
 *
 */
void RC2PY1Profile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RC2PY1Profile::getSetValue()
{
	return _setValue;
}
