 ...
 *
 */
RRtoSRProfile::RRtoSRProfile(TalonSRX & talon) : _talon(talon), _notifer(&RRtoSRProfile::PeriodicTask, this)
{
 ...
 *
 */
void RRtoSRProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RRtoSRProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RRtoSRProfile::startFilling()
{
	startFilling(kRRtoSRProfile, kRRtoSRProfileSz);
}

/**
 *
 */
void RRtoSRProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RRtoSRProfile::getSetValue()
{
	return _setValue;
}
