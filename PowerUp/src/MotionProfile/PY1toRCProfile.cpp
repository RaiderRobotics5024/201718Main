 ...
 *
 */
PY1toRCProfile::PY1toRCProfile(TalonSRX & talon) : _talon(talon), _notifer(&PY1toRCProfile::PeriodicTask, this)
{
...
{
	startFilling(kPY1toRCProfile, kPY1toRCProfileSz);
}

/**
 *
 */
void PY1toRCProfile::startFilling(const double profile[][3], int totalCnt)
{
