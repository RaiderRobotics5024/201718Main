 ...
 *
 */
PY1toRCProfile::PY1toRCProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PY1toRCProfile::PeriodicTask, this)
{
