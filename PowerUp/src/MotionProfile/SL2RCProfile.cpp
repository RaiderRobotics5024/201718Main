 ...
 *
 */
SL2RCProfile::SL2RCProfile(TalonSRX & talon) : _talon(talon), _notifer(&SL2RCProfile::PeriodicTask, this)
{
 ...
 *
 */
void SL2RCProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration SL2RCProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void SL2RCProfile::startFilling()
{
	startFilling(kSL2RCProfile, kSL2RCProfileSz);
}

/**
 *
 */
void SL2RCProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile SL2RCProfile::getSetValue()
{
	return _setValue;
}
