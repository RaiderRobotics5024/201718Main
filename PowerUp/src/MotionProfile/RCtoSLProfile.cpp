 ...
 *
 */
RCtoSLProfile::RCtoSLProfile(TalonSRX & talon) : _talon(talon), _notifer(&RCtoSLProfile::PeriodicTask, this)
{
...
{
	startFilling(kRCtoSLProfile, kRCtoSLProfileSz);
}

/**
 *
 */
void RCtoSLProfile::startFilling(const double profile[][3], int totalCnt)
{
