 ...
 *
 */
RLtoSRProfile::RLtoSRProfile(TalonSRX & talon) : _talon(talon), _notifer(&RLtoSRProfile::PeriodicTask, this)
{
...
{
	startFilling(kRLtoSRProfile, kRLtoSRProfileSz);
}

/**
 *
 */
void RLtoSRProfile::startFilling(const double profile[][3], int totalCnt)
{
