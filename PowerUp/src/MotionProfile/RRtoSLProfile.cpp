 ...
 *
 */
RRtoSLProfile::RRtoSLProfile(TalonSRX & talon) : _talon(talon), _notifer(&RRtoSLProfile::PeriodicTask, this)
{
...
{
	startFilling(kRRtoSLProfile, kRRtoSLProfileSz);
}

/**
 *
 */
void RRtoSLProfile::startFilling(const double profile[][3], int totalCnt)
{
