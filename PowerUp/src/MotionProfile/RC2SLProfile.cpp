 ...
 *
 */
RC2SLProfile::RC2SLProfile(TalonSRX & talon) : _talon(talon), _notifer(&RC2SLProfile::PeriodicTask, this)
{
 ...
 *
 */
void RC2SLProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RC2SLProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RC2SLProfile::startFilling()
{
	startFilling(kRC2SLProfile, kRC2SLProfileSz);
}

/**
 *
 */
void RC2SLProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RC2SLProfile::getSetValue()
{
	return _setValue;
}
