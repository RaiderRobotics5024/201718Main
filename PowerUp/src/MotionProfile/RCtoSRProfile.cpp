 ...
 *
 */
RCtoSRProfile::RCtoSRProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RCtoSRProfile::PeriodicTask, this)
{
