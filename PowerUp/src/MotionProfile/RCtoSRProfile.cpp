 ...
 *
 */
RCtoSRProfile::RCtoSRProfile(TalonSRX & talon) : _talon(talon), _notifer(&RCtoSRProfile::PeriodicTask, this)
{
...
{
	startFilling(kRCtoSRProfile, kRCtoSRProfileSz);
}

/**
 *
 */
void RCtoSRProfile::startFilling(const double profile[][3], int totalCnt)
{
