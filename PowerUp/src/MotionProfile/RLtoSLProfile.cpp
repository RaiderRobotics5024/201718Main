 ...
 *
 */
RLtoSLProfile::RLtoSLProfile(TalonSRX & talon) : _talon(talon), _notifer(&RLtoSLProfile::PeriodicTask, this)
{
...
{
	startFilling(kRLtoSLProfile, kRLtoSLProfileSz);
}

/**
 *
 */
void RLtoSLProfile::startFilling(const double profile[][3], int totalCnt)
{
