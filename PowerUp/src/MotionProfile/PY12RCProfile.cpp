 ...
 *
 */
PY12RCProfile::PY12RCProfile(TalonSRX & talon) : _talon(talon), _notifer(&PY12RCProfile::PeriodicTask, this)
{
 ...
 *
 */
void PY12RCProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration PY12RCProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void PY12RCProfile::startFilling()
{
	startFilling(kPY12RCProfile, kPY12RCProfileSz);
}

/**
 *
 */
void PY12RCProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile PY12RCProfile::getSetValue()
{
	return _setValue;
}
