 ...
 *
 */
RCtoPY1Profile::RCtoPY1Profile(TalonSRX & talon) : _talon(talon), _notifer(&RCtoPY1Profile::PeriodicTask, this)
{
...
{
	startFilling(kRCtoPY1Profile, kRCtoPY1ProfileSz);
}

/**
 *
 */
void RCtoPY1Profile::startFilling(const double profile[][3], int totalCnt)
{
