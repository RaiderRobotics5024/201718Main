 ...
 *
 */
SLtoRCProfile::SLtoRCProfile(TalonSRX & talon) : _talon(talon), _notifer(&SLtoRCProfile::PeriodicTask, this)
{
...
{
	startFilling(kSLtoRCProfile, kSLtoRCProfileSz);
}

/**
 *
 */
void SLtoRCProfile::startFilling(const double profile[][3], int totalCnt)
{
