 ...
 *
 */
SRtoRCProfile::SRtoRCProfile(TalonSRX & talon) : _talon(talon), _notifer(&SRtoRCProfile::PeriodicTask, this)
{
...
{
	startFilling(kSRtoRCProfile, kSRtoRCProfileSz);
}

/**
 *
 */
void SRtoRCProfile::startFilling(const double profile[][3], int totalCnt)
{
