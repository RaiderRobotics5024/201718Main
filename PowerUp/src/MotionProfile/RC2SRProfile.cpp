 ...
 *
 */
RC2SRProfile::RC2SRProfile(TalonSRX & talon) : _talon(talon), _notifer(&RC2SRProfile::PeriodicTask, this)
{
 ...
 *
 */
void RC2SRProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RC2SRProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RC2SRProfile::startFilling()
{
	startFilling(kRC2SRProfile, kRC2SRProfileSz);
}

/**
 *
 */
void RC2SRProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RC2SRProfile::getSetValue()
{
	return _setValue;
}
