 ...
 *
 */
MotionProfiler::MotionProfiler(TalonSRX & talon) : _talon(talon), _notifer(&MotionProfiler::PeriodicTask, this)
{
 ...
 *
 */
void MotionProfiler::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration MotionProfiler::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void MotionProfiler::startFilling()
{
 ...
 *
 */
void MotionProfiler::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile MotionProfiler::getSetValue()
{
	return _setValue;
}
