 ...
 *
 */
RCtoPY1Profile::RCtoPY1Profile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RCtoPY1Profile::PeriodicTask, this)
{
