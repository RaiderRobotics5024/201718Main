...
{
	startFilling(kRRtoSRProfileLeft, kRRtoSRProfileRight, kRRtoSRProfileSz);
}

/**
 *
 */
void RRtoSRProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
