#ifndef _MIDTOVLTPROFILE_HG_
#define _MIDTOVLTPROFILE_HG_

#include "WPILib.h"
#include "ctre/Phoenix.h"
#include "../Instrumentation.h"

#include "../Paths/MIDtoVLTPath.h"

/**
 *
 */
class MIDtoVLTProfile
{
public:
	MIDtoVLTProfile(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
	void control();
