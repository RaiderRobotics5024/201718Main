 ...
 *
 */
bool PY2toRCProfile::isFinished()
{
...
{
	startFilling(kPY2toRCProfileLeft, kPY2toRCProfileRight, kPY2toRCProfileSz);
}

/**
 *
 */
void PY2toRCProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
