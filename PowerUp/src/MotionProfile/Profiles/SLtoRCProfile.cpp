 ...
 *
 */
SLtoRCProfile::SLtoRCProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&SLtoRCProfile::PeriodicTask, this)
{
