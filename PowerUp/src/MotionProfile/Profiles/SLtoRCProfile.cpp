 ...
 *
 */
SLtoRCProfile::SLtoRCProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&SLtoRCProfile::PeriodicTask, this)
{
 ...
 *
 */
void SLtoRCProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration SLtoRCProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void SLtoRCProfile::startFilling()
{
	startFilling(kSLtoRCProfileLeft, kSLtoRCProfileRight, kSLtoRCProfileSz);
}

/**
 *
 */
void SLtoRCProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile SLtoRCProfile::getSetValue()
{
	return _setValue;
}
