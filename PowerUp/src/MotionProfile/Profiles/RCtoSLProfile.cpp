 ...
 *
 */
RCtoSLProfile::RCtoSLProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RCtoSLProfile::PeriodicTask, this)
{
