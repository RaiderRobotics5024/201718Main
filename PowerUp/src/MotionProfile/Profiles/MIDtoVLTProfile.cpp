#include "MIDtoVLTProfile.h"
#include "../../Subsystems/DriveTrainMap.h"

/**
 *
 */
MIDtoVLTProfile::MIDtoVLTProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&MIDtoVLTProfile::PeriodicTask, this)
{
 ...
 *
 */
void MIDtoVLTProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration MIDtoVLTProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
bool MIDtoVLTProfile::isFinished()
{
 ...
 *
 */
void MIDtoVLTProfile::startFilling()
{
	startFilling(kMIDtoVLTProfileLeft, kMIDtoVLTProfileRight, kMIDtoVLTProfileSz);
}

/**
 *
 */
void MIDtoVLTProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile MIDtoVLTProfile::getSetValue()
{
	return _setValue;
}
