 ...
 *
 */
RLtoSRProfile::RLtoSRProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RLtoSRProfile::PeriodicTask, this)
{
