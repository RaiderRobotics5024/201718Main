 ...
 *
 */
RLtoSRProfile::RLtoSRProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RLtoSRProfile::PeriodicTask, this)
{
 ...
 *
 */
void RLtoSRProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RLtoSRProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RLtoSRProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RLtoSRProfile::getSetValue()
{
	return _setValue;
}
