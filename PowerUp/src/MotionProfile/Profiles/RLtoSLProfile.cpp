 ...
 *
 */
RLtoSLProfile::RLtoSLProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RLtoSLProfile::PeriodicTask, this)
{
 ...
 *
 */
void RLtoSLProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RLtoSLProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RLtoSLProfile::startFilling()
{
	startFilling(kRLtoSLProfileLeft, kRLtoSLProfileRight, kRLtoSLProfileSz);
}

/**
 *
 */
void RLtoSLProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RLtoSLProfile::getSetValue()
{
	return _setValue;
}
