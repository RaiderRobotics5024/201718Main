 ...
 *
 */
RLtoSLProfile::RLtoSLProfile(TalonSRX & talonLeft, TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RLtoSLProfile::PeriodicTask, this)
{
