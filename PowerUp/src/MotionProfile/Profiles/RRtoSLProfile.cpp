 ...
 *
 */
RRtoSLProfile::RRtoSLProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RRtoSLProfile::PeriodicTask, this)
{
 ...
 *
 */
void RRtoSLProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RRtoSLProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RRtoSLProfile::startFilling()
{
	startFilling(kRRtoSLProfileLeft, kRRtoSLProfileRight, kRRtoSLProfileSz);
}

/**
 *
 */
void RRtoSLProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RRtoSLProfile::getSetValue()
{
	return _setValue;
}
