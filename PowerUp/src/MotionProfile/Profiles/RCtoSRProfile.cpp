 ...
 *
 */
RCtoSRProfile::RCtoSRProfile(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : _talonLeft(talonLeft), _talonRight(talonRight), _notifer(&RCtoSRProfile::PeriodicTask, this)
{
 ...
 *
 */
void RCtoSRProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration RCtoSRProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void RCtoSRProfile::startFilling()
{
	startFilling(kRCtoSRProfileLeft, kRCtoSRProfileRight, kRCtoSRProfileSz);
}

/**
 *
 */
void RCtoSRProfile::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile RCtoSRProfile::getSetValue()
{
	return _setValue;
}
