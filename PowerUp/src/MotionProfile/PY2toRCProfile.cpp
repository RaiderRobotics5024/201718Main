 ...
 *
 */
PY2toRCProfile::PY2toRCProfile(TalonSRX & talon) : _talon(talon), _notifer(&PY2toRCProfile::PeriodicTask, this)
{
 ...
 *
 */
void PY2toRCProfile::PeriodicTask()
{
 ...
 *
 */
TrajectoryDuration PY2toRCProfile::GetTrajectoryDuration(int durationMs)
{
 ...
 *
 */
void PY2toRCProfile::startFilling()
{
	startFilling(kPY2toRCProfile, kPY2toRCProfileSz);
}

/**
 *
 */
void PY2toRCProfile::startFilling(const double profile[][3], int totalCnt)
{
 ...
 *
 */
SetValueMotionProfile PY2toRCProfile::getSetValue()
{
	return _setValue;
}
